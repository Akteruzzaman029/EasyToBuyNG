...
export class GeneralRegistrationComponent {
  ...
  Registration() {
    this.oAspNetUsersRequestDto.fullName =
      this.oAspNetUsersRequestDto.firstName +
      ' ' +
      this.oAspNetUsersRequestDto.lastName;
    if (this.oAspNetUsersRequestDto.fullName == '') {
      this.toast.warning('Please enter fullName', 'Warning!!', {
        progressBar: true,
      });
      return;
    }
    ...
    if (this.oAspNetUsersRequestDto.email == '') {
      this.toast.warning('Please enter email', 'Warning!!', {
        progressBar: true,
      });
      return;
    }
    if (!CommonHelper.IsValidEmail(this.oAspNetUsersRequestDto.email)) {
      this.toast.warning('Please enter valid email.', 'Warning!!', {
        progressBar: true,
      });
      return;
    }
    ...
    if (!CommonHelper.isValidNumber(this.oAspNetUsersRequestDto.phoneNumber)) {
      this.toast.warning('Number must be exactly 11 digits.', 'Warning!!', {
        progressBar: true,
      });
      return;
    }
    ...
    if (this.oAspNetUsersRequestDto.password == '') {
      this.toast.warning('Please enter password', 'Warning!!', {
        progressBar: true,
      });
      return;
    }
    ...
    if (this.oAspNetUsersRequestDto.confirmPassword == '') {
      this.toast.warning('Please enter confirm password', 'Warning!!', {
        progressBar: true,
      });
      return;
    }
    ...
    this.http
      .Post(`AspNetUsers/InsertAspNetUsers`, this.oAspNetUsersRequestDto)
      .subscribe(
        (res: any) => {
